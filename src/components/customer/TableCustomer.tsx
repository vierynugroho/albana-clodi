...
export default function TableCustomer({ customers, deleteCustomer, editCustomer }: Props) {
					...
					<TableBody className='divide-y divide-gray-100 dark:divide-white/[0.05]'>
						{customers.map((customer) => (
							<TableRow key={customer.id}>
								...
								<TableCell className='px-4 py-3 text-gray-500 text-start text-theme-sm dark:text-gray-400'>{customer.category}</TableCell>
								...
								<TableCell className='px-4 py-3 text-gray-500 text-start text-theme-sm dark:text-gray-400'>{customer.address}</TableCell>
								<TableCell className='px-4 py-3 text-gray-500 text-start text-theme-sm dark:text-gray-400'>
			...
			{showDeleteModal && (
				<div className='fixed inset-0 z-50 flex items-center justify-center  bg-opacity-50'>
					<div className='bg-black bg-blend-color text-white rounded-lg p-6 w-full max-w-md'>
						...
						<p className='mb-6'>Apakah Anda yakin ingin menghapus customer ini?</p>
