      ...
      try {
        ...
        const mappedInitialData = {
          orders: order.OrderDetail.OrderProducts.map((orderProduct) => {
            ...
            // Sesuaikan possible null pada harga dan hargaSetelahDiskon
            let hargaSetelahDiskon: number | null = null;
            if (harga !== null && harga !== undefined) {
              if (discountItem) {
                if (discountItem.discountType === "nominal") {
                  hargaSetelahDiskon = harga - discountItem.discountAmount;
                } else {
                  hargaSetelahDiskon =
            ...
            return {
              ...
              subtotal:
                hargaSetelahDiskon !== null
                  ? hargaSetelahDiskon * orderProduct.productQty
                  : 0,
            };
          }),
