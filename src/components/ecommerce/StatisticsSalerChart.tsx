		...
		<div className='rounded-2xl border border-gray-200 bg-white px-5 pb-5 pt-5 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6 sm:pt-6'>
			<div className='flex flex-col gap-5 mb-6 sm:flex-row sm:justify-between'>
				<div className='w-full'>
					...
					<p className='mt-1 text-gray-500 text-theme-sm dark:text-gray-400'>Produk Terjual : 23 Produk</p>
				</div>
          ...
          <ChartTab />
			...
			<div className='flex justify-end text-md pt-4 pb-2'>
				...
				>
					...
					<div className={showChartSaler ? 'text-theme-sm ml-0.5' : 'text-gray-400 text-theme-sm ml-0.5'}>Penjualan item</div>
				</label>
			</div>
		</div>
	);
