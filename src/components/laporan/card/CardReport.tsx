...
export default function CardReport({
  ...
  return (
    <div
      className={`p-4 bg-white shadow-md rounded-2xl flex flex-col items-start gap-2 hover:shadow-blue-300 border cursor-pointer h-[185px] dark:bg-gray-dark dark:border-gray-800 dark:hover:shadow-blue-300 ${className}`}
    >
